...
public class Special_InspectPlanController : BaseController
{
    private readonly Special_InspectPlanApp _app;
    private readonly IRepository<Special_Equipment> _equipRepo;

    public Special_InspectPlanController(IAuth auth, Special_InspectPlanApp app, IRepository<Special_Equipment> equipRepo) : base(auth)
    {
        _app = app;
    ...
    [HttpPost]
    public IActionResult Save([FromBody] Special_InspectPlan e)
    {
