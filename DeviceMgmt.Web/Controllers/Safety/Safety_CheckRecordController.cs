...
public class Safety_CheckRecordController : BaseController
{
    private readonly Safety_CheckRecordApp _app;
    private readonly IRepository<Safety_Accessory> _accRepo;

    public Safety_CheckRecordController(IAuth auth, Safety_CheckRecordApp app, IRepository<Safety_Accessory> accRepo) : base(auth)
    {
        _app = app;
        _accRepo = accRepo;
    }
    ...
    [HttpPost]
    public IActionResult Save([FromBody] Safety_CheckRecord e)
    {
