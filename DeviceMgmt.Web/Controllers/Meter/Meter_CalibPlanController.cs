...
public class Meter_CalibPlanController : BaseController
{
    private readonly Meter_CalibPlanApp _app;
    private readonly IRepository<Meter> _meterRepo;

    public Meter_CalibPlanController(IAuth auth, Meter_CalibPlanApp app, IRepository<Meter> meterRepo) : base(auth)
    {
        _app = app;
    ...
    [HttpPost]
    public IActionResult Save([FromBody] Meter_CalibPlan e)
    {
