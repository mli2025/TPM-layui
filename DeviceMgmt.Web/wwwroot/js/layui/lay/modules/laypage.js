...
layui.define(function (exports) {
    ...
    Class.prototype.view = function () {
        ...
        config.prev = 'prev' in config ? config.prev : lang.prev; //上一页文本
        config.next = 'next' in config ? config.next : lang.next; //下一页文本
        ...
        var index = config.pages > groups
            ...
            , views = {
                ...
                //数据总数
                , count: '<span class="layui-laypage-count">' + lang.total + config.count + '</span>'
                ...
                //跳页区域
                , skip: function () {
                    return ['<span class="layui-laypage-skip">' + lang.to
                        , '<input type="text" min="1" value="' + config.curr + '" class="layui-input">'
                        , lang.page + '<button type="button" class="layui-laypage-btn">' + lang.btnJump + '</button>'
                        , '</span>'].join('');
                }()
            };
