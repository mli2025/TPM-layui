                ...
                for (let j = 0; j < data[i].Children.length; j++) {
                    ...
                    if (subcurDataChildren == null || subcurDataChildren.length == 0) {
                        ...
                        for (var k = 0; k < subcurDataChildren.length; k++) {
                            ...
                            //ulHtml += getHtml(subsubData);
                            let subsubDataChildren = subcurDataChildren[k].Children;
                            if (subsubDataChildren == null || subsubDataChildren.length == 0) {
                                ...
                                ulHtml += '<dd data-id="' + subsubData.Id + '" data-name="grid"  title="' + subsubData.Name + '">';
                                ulHtml += '<a  href="javascript:;" >';
                                if (subsubData.IconName !== undefined && subsubData.IconName !== '') {
                                    if (subsubData.IconName.indexOf('fa-') !== -1) {
                                        ulHtml += '<i class="fa fa-fw ' + subsubData.IconName + '" data-icon="' + subsubData.IconName + '" aria-hidden="true"></i>';
                                ...
                                ulHtml += '</a>';
                                ulHtml += '<dl class="layui-nav-child">'
                                for (var l = 0; l < subsubDataChildren.length; l++) {
                                    let subsubCurData = subsubDataChildren[l].Item;
                                    ulHtml += '<dd data-id="' + subsubCurData.Id + '" title="' + subsubCurData.Name + '">';
                                    ulHtml += '<a href="javascript:;" data-url="' + subsubCurData.Url + '">';
                                    if (subsubCurData.IconName !== undefined && subsubCurData.IconName !== '') {
                                        if (subsubCurData.IconName.indexOf('fa-') !== -1) {
                                            ulHtml += '<i class="fa fa-fw ' + subsubCurData.IconName + '" data-icon="' + subsubCurData.IconName + '" aria-hidden="true"></i>';
                                        } else {
                                            ulHtml += '<i class="layui-icon" data-icon="' + subsubCurData.IconName + '">' + subsubCurData.IconName + '</i>';
                                        }
                                    }
                                    ulHtml += '<cite>' + subsubCurData.Name + '</cite>';
                                    ulHtml += '</a>';
                                    ulHtml += '</dd>';
                                }
