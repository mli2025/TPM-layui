var convertTool = new unitConversion();
(function ($) {
    ...
    var ChangePxToMm = function (px) {
        return convertTool.pxConversionMm(px)+"mm";
    }
})(jQuery);
